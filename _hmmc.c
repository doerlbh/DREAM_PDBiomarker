...
static const char __pyx_k_Users_DoerLBH_Dropbox_git_DREAM[] = "/Users/DoerLBH/Dropbox/git/DREAM_PDBiomarker/_hmmc.pyx";
...
static PyObject *__pyx_kp_s_Users_DoerLBH_Dropbox_git_DREAM;
...
static PyObject *__pyx_pw_5_hmmc_3_backward(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_backward (wrapper)", 0);
  {
    ...
    __pyx_v_log_startprob = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5_hmmc_dtype_t(values[2]); if (unlikely(!__pyx_v_log_startprob.memview)) __PYX_ERR(0, 69, __pyx_L3_error)
    __pyx_v_log_transmat = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[3]); if (unlikely(!__pyx_v_log_transmat.memview)) __PYX_ERR(0, 70, __pyx_L3_error)
    __pyx_v_framelogprob = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[4]); if (unlikely(!__pyx_v_framelogprob.memview)) __PYX_ERR(0, 71, __pyx_L3_error)
    __pyx_v_bwdlattice = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[5]); if (unlikely(!__pyx_v_bwdlattice.memview)) __PYX_ERR(0, 72, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyObject *__pyx_pw_5_hmmc_5_compute_log_xi_sum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_compute_log_xi_sum (wrapper)", 0);
  {
    ...
    __pyx_v_fwdlattice = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[2]); if (unlikely(!__pyx_v_fwdlattice.memview)) __PYX_ERR(0, 91, __pyx_L3_error)
    __pyx_v_log_transmat = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[3]); if (unlikely(!__pyx_v_log_transmat.memview)) __PYX_ERR(0, 92, __pyx_L3_error)
    __pyx_v_bwdlattice = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[4]); if (unlikely(!__pyx_v_bwdlattice.memview)) __PYX_ERR(0, 93, __pyx_L3_error)
    __pyx_v_framelogprob = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[5]); if (unlikely(!__pyx_v_framelogprob.memview)) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_log_xi_sum = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[6]); if (unlikely(!__pyx_v_log_xi_sum.memview)) __PYX_ERR(0, 95, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyObject *__pyx_pw_5_hmmc_7_viterbi(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_viterbi (wrapper)", 0);
  {
    ...
    __pyx_v_log_startprob = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5_hmmc_dtype_t(values[2]); if (unlikely(!__pyx_v_log_startprob.memview)) __PYX_ERR(0, 119, __pyx_L3_error)
    __pyx_v_log_transmat = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[3]); if (unlikely(!__pyx_v_log_transmat.memview)) __PYX_ERR(0, 120, __pyx_L3_error)
    __pyx_v_framelogprob = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5_hmmc_dtype_t(values[4]); if (unlikely(!__pyx_v_framelogprob.memview)) __PYX_ERR(0, 121, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_DoerLBH_Dropbox_git_DREAM, __pyx_k_Users_DoerLBH_Dropbox_git_DREAM, sizeof(__pyx_k_Users_DoerLBH_Dropbox_git_DREAM), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__19 = (PyObject*)__Pyx_PyCode_New(7, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__18, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_DoerLBH_Dropbox_git_DREAM, __pyx_n_s_compute_log_xi_sum, 90, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__19)) __PYX_ERR(0, 90, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_DoerLBH_Dropbox_git_DREAM, __pyx_n_s_viterbi, 118, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 118, __pyx_L1_error)
 ...
 *               dtype_t[:, :] log_transmat,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5_hmmc_3_backward, NULL, __pyx_n_s_hmmc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                         dtype_t[:, :] log_transmat,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5_hmmc_5_compute_log_xi_sum, NULL, __pyx_n_s_hmmc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *              dtype_t[:, :] log_transmat,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5_hmmc_7_viterbi, NULL, __pyx_n_s_hmmc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
